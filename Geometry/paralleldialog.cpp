...
ParallelDialog::ParallelDialog(Repository* context, QWidget *parent) :
    QDialog(parent)
{
    ...
    connect(this,SIGNAL(find_parallel(Point*,Line*)),context,SLOT(find_parallel_line(Point*,Line*)));

    setWindowTitle("Generate parallel line through point");
}

void ParallelDialog::enable_line_selection(int id)
{
    if(id==0)
    {
...
void ParallelDialog::enable_point_selection(int id)
{
    if(id==0)
    {
...
void ParallelDialog::select_line(int index)
{
    if(index>-1)
    {
...
void ParallelDialog::select_point(int index)
{
    if(index>-1)
    {
...
void ParallelDialog::process_input()
{
